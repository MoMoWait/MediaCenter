/**
 * Title: LocalMediaInfo.java<br>
 * Package: com.rockchips.mediacenter.localscan.common.bean<br>
 * Description: TODO<br>
 * @author c00224451
 * @version v1.0<br>
 * Date: 2014-7-7上午10:50:08<br> 
 * Copyright © Huawei Technologies Co., Ltd. 2014. All rights reserved.
 */

package com.rockchips.mediacenter.basicutils.bean;
...
public class LocalMediaInfo
{
    ...
    public void decompress(Bundle bundle)
    {
        ...
        setmFileType(bundle.getInt(FILE_TYPE, Constant.MediaType.UNKNOWN_TYPE));
        ...
        setmDeviceType(bundle.getInt(DEVICETYPE, Constant.DeviceType.DEVICE_TYPE_UNKNOWN));
    ...
    public String getUrl()
    {
        switch (mDeviceType)
        {
            case Constant.DeviceType.DEVICE_TYPE_DMS:
                return mResUri;
