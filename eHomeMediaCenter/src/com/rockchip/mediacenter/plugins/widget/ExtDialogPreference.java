 ...
 */
public abstract class ExtDialogPreference extends Preference implements
        DialogInterface.OnClickListener, DialogInterface.OnDismissListener,
        PreferenceManager.OnActivityDestroyListener {
    private Alert.Builder mBuilder;
    ...
    public ExtDialogPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    public ExtDialogPreference(Context context, AttributeSet attrs) {
     ...
     */
    protected void onPrepareDialogBuilder(Alert.Builder builder) {
    }
    ...
    protected void showDialog(Bundle state) {
        ...
        mBuilder = new Alert.Builder(context)
