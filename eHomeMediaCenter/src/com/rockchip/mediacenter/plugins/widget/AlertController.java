...
public class AlertController {
    ...
    public void installContent() {
        ...
        mWindow.setContentView(R.layout.sys_alert_dialog);
        setupView();
    }
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int fullDark = a.getResourceId(
                R.styleable.AlertDialog_fullDark, 0);
        int topDark = a.getResourceId(
                R.styleable.AlertDialog_topDark, R.drawable.sys_dialog_top);
        int centerDark = a.getResourceId(
                R.styleable.AlertDialog_centerDark, R.drawable.sys_dialog_center);
        int bottomDark = a.getResourceId(
                R.styleable.AlertDialog_bottomDark, R.drawable.sys_dialog_bottom);
        int fullBright = a.getResourceId(
                R.styleable.AlertDialog_fullBright, 0);
        int topBright = a.getResourceId(
                R.styleable.AlertDialog_topBright, R.drawable.sys_dialog_top);
        int centerBright = a.getResourceId(
                R.styleable.AlertDialog_centerBright, R.drawable.sys_dialog_center);
        int bottomBright = a.getResourceId(
                R.styleable.AlertDialog_bottomBright, R.drawable.sys_dialog_bottom);
        int bottomMedium = a.getResourceId(
                R.styleable.AlertDialog_bottomMedium, R.drawable.sys_dialog_bottom);
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
            final RecycleListView listView = (RecycleListView)
                    mInflater.inflate(R.layout.sys_select_dialog, null);
            ListAdapter adapter;
            
            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, R.layout.sys_select_dialog_multichoice, android.R.id.text1, mItems) {
                        @Override
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return mInflater.inflate(R.layout.sys_select_dialog_multichoice,
                                    parent, false);
                        }
                ...
                int layout = mIsSingleChoice 
                        ? R.layout.sys_select_dialog_singlechoice : R.layout.sys_select_dialog_item;
                if (mCursor == null) {
