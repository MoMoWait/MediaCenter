...
//    private int state = STATE_IDLE;
    ...
    private Bitmap loadThumbnailFromCache(LocalMediaInfo info, int width, int height)
    {
        ...
        {
            case Constant.MediaType.IMAGEFOLDER:
                // case Constant.MediaType.AUDIOFOLDER:
                // case Constant.MediaType.VIDEOFOLDER:
            ...
            do
            {
                ...
                if (nowDoingTaskLocalMediaInfo != null)
                {
                    ...
                    if (thumbnail_bitmap == null)
                    {
                        ...
                        if (mediaType == Constant.MediaType.IMAGE || mediaType == Constant.MediaType.AUDIO || mediaType == Constant.MediaType.VIDEO)
                        {
                            if (Constant.DeviceType.isDLNADevice(devType))
                            {
                        ...
                        else if (mediaType == Constant.MediaType.IMAGEFOLDER || mediaType == Constant.MediaType.FOLDER)
                        {
                            if (Constant.DeviceType.isDLNADevice(devType))
                            {
                                downloadUri = nowDoingTaskLocalMediaInfo.getUrl();
