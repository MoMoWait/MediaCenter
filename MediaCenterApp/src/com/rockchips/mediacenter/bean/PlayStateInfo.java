...
//                if (bindle.getInt("DEVICE_TYPE") == ConstData.DeviceType.DEVICE_TYPE_CLOUD)
//                {
        ...
        synchronized (this)
        {
            while (mMediaList.size() > 0 && !isStop())
            {
                ...
                if (!StringUtils.isEmpty(mbi.getUrl()))
                {
                    ...
                    // ConstData.DeviceType.DEVICE_TYPE_U &&
                    // FileUtils.isExists(mbi.getData()))
                    // {
                    // break;
                    // }
                    // else if (mbi.getDeviceType() ==
                    // ConstData.DeviceType.DEVICE_TYPE_DMS &&
...
//            
//            if (iret == 0 && dbi1.getDeviceType() == ConstData.DeviceType.DEVICE_TYPE_U)
//            {
