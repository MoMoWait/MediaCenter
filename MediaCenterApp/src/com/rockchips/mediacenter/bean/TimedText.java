...
public class TimedText
{
    ...
    /**
     * Helper class to hold the text length and text content of one text sample.
    ...
    /**
     * Helper class to hold the start char offset and end char offset for
     * Blinking Text or Highlight Text. endChar is the end offset of the text
     * (startChar + number of characters to be highlighted or blinked). The
     * member variables in this class are read-only.
     */
    ...
    /**
     * Helper class to hold the box position to display the text sample. The
     * member variables in this class are read-only.
     */
    ...
    /**
     * Helper class to hold the style information to display the text. The
     * member variables in this class are read-only.
     */
    public class Style
    {
        ...
        /**
         * ID of the font. This ID will be used to choose the font to be used
         * from the font list.
         */
        public int fontID = -1;
        ...
        /**
         * To specify the RGBA color: 8 bits each of red, green, blue, and an
    ...
    /**
     * Helper class to hold the font ID and name. The member variables in this
     * class are read-only.
     */
    public class Font
    {
    ...
    /**
     * Helper class to hold the karaoke information. The member variables in
    ...
    public class Karaoke
    {
        ...
        /**
         * The end time (in milliseconds) to highlight the characters specified
         * by startChar and endChar.
         */
    ...
    /**
     * Helper class to hold the hyper text information. The member variables in
     * this class are read-only.
     */
     ...
     * @throws IllegalArgumentExcept if parseParcel() fails. {@hide}
     */
    ...
    {
        if (!((key >= FIRST_PUBLIC_KEY) && (key <= LAST_PUBLIC_KEY)) && !((key >= FIRST_PRIVATE_KEY) && (key <= LAST_PRIVATE_KEY)))
        {
            return false;
        }
        return true;
     ...
     * @param key the key to be checked.
     * @return true if the key is contained in this TimedText object. Otherwise,
     *         false.
     */
    ...
    /**
     * To retrieve the object associated with the key. Caller must make sure the
     * key is present using the containsKey method otherwise a RuntimeException
     * will occur.
     * @param key the key used to retrieve the object.
     * @return an object. The object could be an instanceof Integer, List, or
     *         any of the helper classes such as TextPos, Justification, and
     *         Text.
     */
